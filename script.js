          ...
          <div class="conteudo">
            ...
            <table class=tabela>
              ...
              ${Array.from(datasAulas).map(dataAula => {
                  const linha1 = `<tr><td>${contador++}ª ${dataAula.innerHTML.padStart(2, '0')}/${String(data.getMonth() + 1).padStart(2, '0')}/${data.getFullYear()}</td>
                  <td>08:00 às 09:00</td>
                  <td>R$ 100,00</td>
                  <td></td></tr>`;
                  const linha2 = `<tr><td>${contador++}ª ${dataAula.innerHTML.padStart(2, '0')}/${String(data.getMonth() + 1).padStart(2, '0')}/${data.getFullYear()}</td>
